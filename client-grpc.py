...
class Client:
    ...
    # NEEDS TO BE CHANGED FROM DJISKSTRA'S SOURCE CODE
    ...
    def joinChat(User):
        # should return JoinAbility
        pass

    def displayUserList(baseMessage):
        # should return UsernameList
        pass

    def sendMessage(MessageInfo):
        # should return baseMessage
        pass

    def receiveMessage(baseMessage):
        # should return a stream of MessageInfo
        pass
    ...
    # WE NEED TO FIGURE OUT WHAT ALL THEIR UI STUFF IS AND DELETE IT
    def __setup_ui(self):
        self.chat_list = Text()
...
# DON'T KNOW WHICH OF THIS STUFF WE SHOULD KEEP
